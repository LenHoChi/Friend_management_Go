...
type Relationship struct {
	...
	FriendEmail string `boil:"friend_email" json:"friend_email" toml:"friend_email" yaml:"friend_email"`
	Arefriends  bool   `boil:"arefriends" json:"arefriends" toml:"arefriends" yaml:"arefriends"`
	Issubcriber bool   `boil:"issubcriber" json:"issubcriber" toml:"issubcriber" yaml:"issubcriber"`
	Isblock     bool   `boil:"isblock" json:"isblock" toml:"isblock" yaml:"isblock"`
...
var RelationshipWhere = struct {
	...
	FriendEmail whereHelperstring
	Arefriends  whereHelperbool
	Issubcriber whereHelperbool
	Isblock     whereHelperbool
}{
	UserEmail:   whereHelperstring{field: "\"relationship\".\"user_email\""},
	FriendEmail: whereHelperstring{field: "\"relationship\".\"friend_email\""},
	Arefriends:  whereHelperbool{field: "\"relationship\".\"arefriends\""},
	Issubcriber: whereHelperbool{field: "\"relationship\".\"issubcriber\""},
	Isblock:     whereHelperbool{field: "\"relationship\".\"isblock\""},
}
...
var (
	relationshipAllColumns            = []string{"user_email", "friend_email", "arefriends", "issubcriber", "isblock"}
	relationshipColumnsWithoutDefault = []string{"user_email", "friend_email", "arefriends", "issubcriber", "isblock"}
	relationshipColumnsWithDefault    = []string{}
	relationshipPrimaryKeyColumns     = []string{"user_email", "friend_email"}
)
...
func FindRelationship(ctx context.Context, exec boil.ContextExecutor, userEmail string, friendEmail string, selectCols ...string) (*Relationship, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"relationship\" where \"user_email\"=$1 AND \"friend_email\"=$2", sel,
	)

	q := queries.Raw(query, userEmail, friendEmail)
...
func (o *Relationship) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"relationship\" WHERE \"user_email\"=$1 AND \"friend_email\"=$2"
...
func (o *Relationship) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindRelationship(ctx, exec, o.UserEmail, o.FriendEmail)
	if err != nil {
		return err
	}
...
func RelationshipExists(ctx context.Context, exec boil.ContextExecutor, userEmail string, friendEmail string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"relationship\" where \"user_email\"=$1 AND \"friend_email\"=$2 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, userEmail, friendEmail)
	}
	row := exec.QueryRowContext(ctx, sql, userEmail, friendEmail)
